...
<div class="store-navigator">
 <h2><a href="store.php">Store</a> / <a href="vodka.php">Vodka</a> / <sp>Grey Goose (750ml.)</sp> </h2>
</div>
<product-card>
<div class="container">
  <div class="product-img">
    <img src="store_products/vodka/vodka3.png">
  </div>
  <div class="product-desc">
    

    <h1>Grey Goose (750ml.)</h1>
    <div class="rating">
   ...
   <h4>Grey Goose® Vodka is a premium vodka, born of an extraordinary passion for spirit-making. It is created using only the finest French ingredients – the highest-grade wheat and pristine limestone-filtered spring water. It is a spirit of uncommon brilliance, unrivaled craftsmanship and signature smoothness and is an excellent choice as a gift.</h4> 
   <h3>$24.99</h3><br>
