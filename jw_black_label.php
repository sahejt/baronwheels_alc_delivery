...
<html>
    <head>
        <title>BoW - JW Black Label (750ml.)</title>
...
<div class="store-navigator">
 <h2><a href="store.php">Store</a> / <a href="whiskey.php">Whiskey</a> / <sp>JW Black Label (750ml.)</sp> </h2>
</div>
<product-card>
<div class="container">
  <div class="product-img">
    <img src="store_products/whiskey/whiskey2.png">
  </div>
  <div class="product-desc">
    

    <h1>JW Black Label (750ml.)</h1>
    <div class="rating">
